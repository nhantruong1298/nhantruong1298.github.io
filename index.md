...
- Responsibility:
  ...
  - Public and manage apps on store.
  - Contribute ideas to improve the app.
- Technical:
...
- Description:
  - Flutter mobile app for employee management allows users to check in online, store images and notes on the server, and sign and confirm minutes online.
- Responsibility:
  - Build the app from scratch.
...
**Martin Charities** _(Jun 2017 - Present)_<br>
